...
<span class="entry-meta-element entry-date posted-on">
	<span class="entry-meta-description label-published">
		<?php echo esc_html_x( '', 'Post meta info description: publish date.', 'reykjavik' ); ?>
	</span>
	...
	<span class="entry-meta-description label-updated">
		<?php echo esc_html_x( 'Actualizado el', 'Post meta info description: update date.', 'reykjavik' ); ?>
	</span>
